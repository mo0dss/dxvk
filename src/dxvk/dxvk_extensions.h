...
namespace dxvk {
  ...
  struct DxvkDeviceExtensions {
    ...
    DxvkExt extSwapchainMaintenance1          = { VK_EXT_SWAPCHAIN_MAINTENANCE_1_EXTENSION_NAME,            DxvkExtMode::Disabled };
  ...
  struct DxvkInstanceExtensions {
    ...
    DxvkExt extSurfaceMaintenance1          = { VK_EXT_SURFACE_MAINTENANCE_1_EXTENSION_NAME,            DxvkExtMode::Disabled };
